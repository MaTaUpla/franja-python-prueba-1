...
Escribir un programa que haga transformaciones de pesos a dólares. Debe preguntarle al usuario si desea transformar de pesos mexicanos a dólares, de pesos chilenos a dólares, o desde pesos argentinos a dólares. Mostrar por pantalla la cantidad de monedas a convertir, la moneda que se convirtió y el monto en dólares.
"""
